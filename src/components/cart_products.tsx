...
import { loadCart, removeItem } from '@/services/carrito.servicio';
      ...
      <div className="flex-1 flex flex-col items-center py-8 px-4 gap-6">
                ...
                <div key={item.id} className="bg-gray-50 rounded-xl p-4 hover:bg-gray-100 transition-all duration-300">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="font-bold text-red-600 text-lg">${item.precio_base}</span>
                    ...
                    <button
                      ...
                      className="p-3 text-gray-400 hover:text-red-500 hover:bg-red-50 rounded-xl transition-all duration-200 flex-shrink-0"
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="w-full max-w-2xl bg-white rounded-2xl shadow-lg p-6">
          ...
          <div className="flex gap-4">
            <button className="flex-1 bg-red-600 hover:bg-red-700 text-white font-bold py-4 px-6 rounded-xl transition-all duration-200 flex items-center justify-center gap-3 hover:scale-105 transform text-xl">
            ...
            <button className="px-6 text-red-600 hover:text-red-700 font-medium hover:bg-red-50 rounded-xl transition-all duration-200 flex items-center gap-2">
