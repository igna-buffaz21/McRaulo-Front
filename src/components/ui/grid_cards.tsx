...
export default function ProductGrid({
  products,
  onProductClick,
  onAddToCart // Nueva prop para manejar añadir al carrito
}: ProductGridProps) {

  const handleAddToCart = (e: React.MouseEvent, product: any) => {
    e.stopPropagation(); // Previene que se ejecute onProductClick
    onAddToCart(product); // Ejecuta la función específica para añadir al carrito
  };
